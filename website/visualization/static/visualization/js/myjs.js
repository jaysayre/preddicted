...
function show(text){
	...
	$.ajax({
        ...
        success: function (data) {
			...
			output2 = "So how was this done? Well we used our CLF of the entire reddit dataset to predict the probability of your post being popular. Then we ran it through our regression model to predict your score! If you'd like to see more, check out the video below or if you'd like to see <b>an even better predictor</b> visit our <a href='http://nbviewer.ipython.org/github/jaysayre/intelligent-dolphins/blob/master/ProcessBook.ipynb'>Process Book</a>"			
			document.getElementById("scoreOutput2").innerHTML = output2;
			output3 = '<iframe id="video" width="100%" height="100%" src="//www.youtube.com/embed/gaTtRLYUFtA" frameborder="0" allowfullscreen></iframe>'	
